...
<div class="container-fluid">
  <div class="row">
      ...
      <table class="table table-bordered" >
        ...
        if (verifica_resultado($result)) {
            while ($row = retorna_linha($result)) {
                ...
                echo "<td><a  href='editar_produto.php?id=" . $row['produto_id'] . "'><span class='material-icons'>
                edit
                </span></a> <a  href='excluir_produto.php?id=" . $row['produto_id'] . "'><span class='material-icons icone-deletar'>
                delete
                </span></a></td>";
                echo "</tr>";
            }
    ...
    <a href="adicionar_produto.php" class="btn btn-primary btn-lg " role="button">Adicionar Produto</a>
    </div>
