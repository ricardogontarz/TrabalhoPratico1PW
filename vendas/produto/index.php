...
<div class="container-fluid">
  <div class="row">
    ...
    <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
      ...
      <a href="/vendas/html/adicionaProduto.html" class="btn btn-primary btn-lg" role="button">Adicionar Produto</a> <br> <br>
      <div >
      <table class="table table-bordered" >
        ...
        if (verifica_resultado($result)) {
            while ($row = retorna_linha($result)) {
                ...
                echo "<td><a  href='/vendas/html/editaProduto.html?id=" . $row['produto_id'] . "'><span class='material-icons'>
                edit
                </span></a> <a  href='/vendas/html/excluiProduto.html?id=" . $row['produto_id'] . "'><span class='material-icons icone-deletar'>
                delete
                </span></a></td>";
                echo "</tr>";
            }
